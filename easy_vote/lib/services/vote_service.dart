...
class VoteService {
  static Future<Question> loadQuestion() async {
    var response = await http.get("http://172.22.20.69:8888/vote");
  ...
  static Future sendVote(Vote vote) async {
    ...
    var response = await http.post("http://172.22.20.69:8888/vote", body: jsonEncode2, headers: {"content-type": "application/json"});
  }
}
